      ...
      <div className="carousel">
        <div className="carousel-left">
          <div className="carousel-left-slide">
            ...
            >
              <div key={1}>
                <img src="https://wscdn.vn/upload/original-image/lg-luxury.png?size=680x400&fomat=webp"></img>
              </div>
              <div key={2}>
                <img src="https://wscdn.vn/upload/original-image/fc-luxury-banner.jpeg?size=680x400&fomat=webp"></img>
              </div>
              <div key={3}>
